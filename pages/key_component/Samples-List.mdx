...
The component uses the react-query library's useQuery hook to fetch the samples from the /api/samples endpoint. The collection_id prop is sent as the request body.
